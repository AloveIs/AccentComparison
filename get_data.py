...
def get_data(label1, label2 = "", balance = False):
    ...
    if label1=="test":
        ...
        data1_train, data1_val, data1_test = gather(label1, ["pitch"], N_samples=200, N_lim=50, divide = [64,16,20])
        data2_train, data2_val, data2_test = gather(label2, ["pitch"], N_samples=200, N_lim=50, divide = [64,16,20])
        if balance:
